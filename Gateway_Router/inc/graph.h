 ...
 * 
 * Definitions for adjacency list graph implementation and helper functions (some funcitons adapted from 15-641 Lab1)
 */
...
struct adjacency_vert {
    ...
    uint16_t num_children; // ALERT! misnomer this is number of neighbors 
